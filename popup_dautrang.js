...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://anthuanphatchem.com' target='_blank'><img src='http://anthuanphatchem.com/upload/hinhanh/banner2_1450371640.png' width='500px'/>hóa chất an thuận phát</a>. nhập khẩu và phân phối hóa chất. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
